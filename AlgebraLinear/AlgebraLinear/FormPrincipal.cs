...
namespace AlgebraLinear
{
    public partial class FormPrincipal : Form
    {
        ...
        //----------------DEFINIR RETANGULO / EXCLUIR CANTO PAINEL 
        ...
        //----------------COR E TAMANHO DO RETANGULO INFERIOR
        ...
        private void Vetores_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Atenção!\nAs operações com vetores só será \npossível na próxima atualização 2.0", "Atualização");
        }

        private void Help_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Atenção!\nA operação help? só será \npossível na proxima atualização 2.0", "Atualização");
        }
    }
}
